...
队列概览按供应商展示待投递、已送达、重试中、失败和合计数量，用于快速判断是否存在堆积或异常供应商。

<img src="./docs/assets/ops-queues.png" alt="队列概览" width="900">

供应商管理展示供应商编码、队列、启用/运行状态，并支持人工暂停或恢复供应商的新任务接入。

<img src="./docs/assets/ops-providers.png" alt="供应商管理" width="900">

通知任务列表支持按供应商和状态筛选，查看事件 ID、投递状态、尝试次数，并进入详情排查失败原因。

<img src="./docs/assets/ops-notifications.png" alt="通知任务" width="900">
